...
const Input = () => {
  ...
  return (
    <div className="flex flex-col items-center my-5">
      ...
      {show && (
        <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 w-full p-10">
          {state.data.map((each) => (
      ...
      {actor && (
        <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 w-full gap-4 p-10">
          {state.data.map((each) => (
